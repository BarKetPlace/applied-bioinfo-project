...
## Install
We need `bash` and `make` for the project. (Anyone using Windows ?)
```
$ make -v
GNU Make 4.1
...
...
## Nomenclature
We chose names for the input and output of the different operations.
The names are such that the content of a file is clear from its name.
